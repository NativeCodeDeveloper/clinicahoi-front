...
<div className="relative min-h-screen overflow-hidden px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
    ...
    <div className="mx-auto max-w-5xl">
        ...
        {/* Cards */}
        <div className="animate-reveal-up-delay mt-14 grid grid-cols-1 justify-items-center gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {listaProfesionales.map((profesional, index) => (
                <button
                    ...
                    className="animate-reveal-up group relative flex w-full flex-col overflow-hidden rounded-3xl border border-[#c9daf8] bg-white p-7 opacity-0 text-left shadow-[0_8px_30px_-18px_rgba(28,65,130,0.55)] transition-all duration-300 hover:-translate-y-1.5 hover:border-[#3881f4]/40 hover:shadow-[0_20px_45px_-20px_rgba(56,129,244,0.35)] sm:p-8"
                >
                    ...
                    {/* Inicial */}
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[#c9daf8] bg-gradient-to-br from-[#eaf1ff] to-[#dce9ff] text-base font-bold text-[#3881f4] shadow-[0_4px_12px_-6px_rgba(56,129,244,0.3)] transition-all duration-300 group-hover:from-[#3881f4] group-hover:to-[#5a9cf8] group-hover:text-white group-hover:shadow-[0_6px_18px_-6px_rgba(56,129,244,0.5)]">
                        {profesional.nombreProfesional?.charAt(0)}
                    </div>

                    {/* Contenido */}
                    <h2 className="mt-5 text-base font-semibold tracking-wide text-[#1f3f76] transition-colors duration-300 group-hover:text-[#3881f4]">
                        {profesional.nombreProfesional}
                    </h2>
                    <p className="mt-2 line-clamp-3 text-[13px] leading-relaxed text-slate-500 transition-colors duration-300 group-hover:text-slate-600">
                        {profesional.descripcionProfesional}
                    </p>

                    {/* CTA */}
                    <div className="mt-6 flex w-full items-center justify-between border-t border-[#e8f0fd] pt-5">
                        ...
                        <div className="flex h-7 w-7 items-center justify-center rounded-full border border-[#d2e0fb] bg-[#f4f8ff] transition-all duration-300 group-hover:border-[#3881f4]/40 group-hover:bg-[#3881f4] group-hover:shadow-[0_4px_12px_-4px_rgba(56,129,244,0.4)]">
